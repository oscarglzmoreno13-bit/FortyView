...
public class ProductoVoConfigutarion {
...
private Integer idProducto;
	...
	private Integer idCofiguracion;
	private Integer idDetalleConfiguracion;
	
	
	
	public Integer getIdCofiguracion() {
		return idCofiguracion;
	}

	public void setIdCofiguracion(Integer idCofiguracion) {
	...
	public ProductoVoConfigutarion() {
		super();
		this.cantidad = Integer.valueOf(0);
		this.productIsSelected = Boolean.FALSE;
